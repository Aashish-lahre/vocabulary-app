...
final class LoadAiWordsEvent extends GeminiEvent {
  ...
  /// Note - autoLoad is only true if [aiWordsGenerationisOn] is on and user starts the app, fetches the very initial batch of words. we expect user would 
  /// immediately see the first word when words have been loaded.
  final bool autoLoad;
